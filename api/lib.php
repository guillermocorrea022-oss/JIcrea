...
$GLOBALS['COLS'] = [
  ...
  'sales'     => ['client_id','client_name','client_contact','sale_type','business','channel','source','status','order_date','delivery_date','paid','paid_date','zone','shipping_info','company','commission_amount','notes','total','total_minorista_ref','total_cost','is_historical','confirmed_at'],
